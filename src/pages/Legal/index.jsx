    ...
    <div className={styles.page}>
      ...
      <div className="container">
        <div className={styles.content}>
          {[
            { id:'mentions', title:'1. Mentions Légales', text:`Otaku Pulse est une entreprise de commerce en ligne spécialisée dans l'evenementiel au Cameroun.\n\nSiège social : Yaoundé, Cameroun\nEmail : contact@otaku-pulse.com\nTéléphone : +237 600 000 000` },
            ...
            { id:'privacy', title:'5. Politique de Confidentialité', text:`Vos données personnelles (nom, email, téléphone, adresse) sont collectées uniquement dans le cadre de la gestion de vos commandes et ne sont jamais vendues à des tiers.\n\nSi vous ouvrez une boutique partenaire, nous collectons en plus : les informations de votre marque (nom, logo, description), vos coordonnées de contact professionnelles, et vos numéros Orange Money / MTN Mobile Money — utilisés exclusivement pour vous reverser votre part des ventes. Vos données de vente (produits, prix, volumes) sont visibles par notre équipe pour le calcul des commissions et le support, jamais partagées avec d'autres partenaires.\n\nNous respectons le RGPD et les lois camerounaises sur la protection des données.\nVous pouvez demander la suppression de vos données à tout moment en nous contactant.` },
            ...
            { id:'shop-policy', title:'8. Politique Boutique Partenaire & Commissions', text:`Toute marque ou vendeur validé sur Otaku Pulse gère son propre catalogue (produits, prix, promotions) via son espace partenaire. Otaku Pulse reste responsable de la gestion centralisée des commandes et livraisons.\n\nBarème de commission (indicatif, sur le prix de vente) :\n• 🌱 Découverte — pendant les 3 premiers mois, ou les 50 premières ventes (le premier des deux atteint) : 5%\n• 🚀 Standard — en rythme de croisière ensuite : 7,5%\n• 🏆 Fidélité — après 1 an d'ancienneté ou 200 ventes cumulées : 5%\n• 💎 Abonnement optionnel (500 FCFA/mois) — taux fixe quel que soit le volume : 4%\n\nGarde-fous : la commission appliquée à un article ne descend jamais sous 25 FCFA ni ne dépasse 250 FCFA, quel que soit son prix.\n\n• Reversement : votre part est reversée sous 48h après confirmation de livraison de la commande.\n• Révision : ce barème peut évoluer, avec un préavis d'au moins 30 jours avant toute modification.\n• Sur-mesure : Otaku Pulse peut convenir d'un taux personnalisé avec certains partenaires selon des accords spécifiques — le taux qui vous est réellement appliqué est toujours visible dans votre espace boutique.` },
            { id:'contact-legal', title:'9. Contact & Réclamations', text:`Pour toute réclamation ou question concernant ces conditions, contactez-nous :\n• Email : legal@otaku-pulse.com\n• WhatsApp : +237 600 000 000\n• Courrier : Otaku Pulse, Yaoundé, Cameroun` },
          ].map(section => (
